...
So the gap is now four contexts wide and its shape is understood: for those
four the eliminated pair is the head and the input, and the lattice of the head
is divided by three or six.  What is missing is a bound on the number of such
...
established for trees that use one of the four, although our constructor
produces integer labellings on every tree we have run it on.
