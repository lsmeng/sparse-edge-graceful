...
$M=\NumLatticeM$ and $|\Placed|+|\mathrm{Reserved}|\le 18(D+1)$, the coordinate
boxes have side at
most $M\bigl(2W(18(D+1)+1)+W^2+1\bigr)=\NumCoordLin(D+1)+\NumCoordCon$.  The
pairing boxes use the refined lattice $M'=\NumLatticeMEff$ of the elimination
step and have side at most
$M'\bigl(3W(36(D+1)+3W)+1\bigr)=\NumPairLin(D+1)+\NumPairCon$.  A
