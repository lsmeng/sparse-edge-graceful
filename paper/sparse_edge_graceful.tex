...
which its authors record in their Section~7.4, the threshold becomes linear,
...
Section~7.4 records that for abelian groups the logarithms may be removed,
...
Assume the abelian improvement of \cite[Section~7.4]{MuyesserPokrovskiy2025},
...
of Section~7.4 at all; the remark is what turns the polylogarithmic threshold
...
gives Theorem~\ref{thm:main}.  Their Section~7.4 records that
